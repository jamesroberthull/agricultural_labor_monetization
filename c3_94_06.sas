*********************************************************************
**     Program Name: /home/jrhull/diss/ch3/c3prog/c3_94_06.sas
...
**            IT GENERATES DATA FOR THE ENTIRE SAMPLE
*********************************************************************;
...
libname in&y.&f.03 xport '/nangrong/data_sas/1994/current/indiv94.04';
libname in&y.&f.04 xport '/nangrong/data_sas/1994/current/comm94.01';
libname in&y.&f.05 xport '/nangrong/data_sas/1994/current/plots94.01';

libname in&y.&f.06 xport '/nangrong/data_sas/1984/current/hh84.01.xpt';

libname ot&y.&f.01 xport '/trainee/jrhull/diss/ch3/c3data/c3_9401B.xpt';
libname ot&y.&f.02 xport '/trainee/jrhull/diss/ch3/c3data/c3_9402B.xpt';
libname ot&y.&f.03 xport '/trainee/jrhull/diss/ch3/c3data/c3_9403B.xpt';
libname ot&y.&f.04 xport '/trainee/jrhull/diss/ch3/c3data/c3_9405B.xpt';
...
data work&y.&f.07 (drop=i j k HELPVB1-HELPVB50 HELPVAT               /*RECODES*/
...
data work&y.&f.08 (drop= i j k);
    ...
    ** CREATE HELPDV4 HERE - 0 = used any free/exchange 1 = all paid **;
...
proc sort data=work&y.&f.10 out=ot&y.&f.01.c3_9401B;
     by HHID94;
run;
...
data work&y.&f.11;
     merge in&y.&f.01.hh94(keep=HHID94 VILL94 DATE in=a)
           in&y.&f.03.indiv94(keep=HHID94 VILL94 LEKTI94 CEP94 Q1 Q3 Q27 Q29 Q30: Q31 Q33 Q34: Q10D Q10M Q10Y in=b);
     by HHID94;
...
data work&y.&f.12;                                                                  *** Create a HH-level file ***;
...
data work&y.&f.13 noricefile;                               *** MERGE HHs w/ migrants to all HHs ***;
     merge work&y.&f.12 (in=a)
           ot&y.&f.01.c3_9401B (in=b);
     by HHID94;
...
data work&y.&f.14 (keep=VILL94 LEKTI94 HHID94 CEP94 Q1 AGE Q3 Q27 Q31);
...
libname ot&y.&f.05 xport '/trainee/jrhull/diss/ch2/c2data/c3_94VLB.xpt';
...
proc sort data=ot&y.&f.02.c3_9402B out=c3_94_02a;
     by HHID94;
run;
...
data work&y.&f.25;
   ...
   /*  if HHTYPE94 in (1,3);   *** Keeps NEW HH's in this final file ***;  */
...
data work&y.&f.72;
     set work&y.&f.71 (keep=hhtype&y helpdv3 m_13_55 f_13_55 numdepch numdepel codetwo
                            ...
                            cassava cottage stock charcoal casset1 passet1 pcasset1
                            workwage pipe_wat wind_0_1 fuel_new fuel_old
                            vill1355 vill_ric v_toodry v_phone ro&y._1 ro&y._2
                            ro&y._3 equip&y vill_rai vill94 hhid&y helpdv5
                            ro&y._A plantnum workwage tothelp h_tot_t h_tot_p h_tot_f
                            v_helpm v_helpf v_help rice_yld all_pd all_p paid_t
                            PAIDPD PAIDPD_2 PAIDPD_V PAIDPD_O
                            FREEPD FREEPD_2 FREEPD_V FREEPD_O
                            EXCHPD EXCHPD_2 EXCHPD_V EXCHPD_O       );
run;
