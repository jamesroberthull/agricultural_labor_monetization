*********************************************************************
**     Program Name: /home/jrhull/diss/ch3/c3prog/c3_94_02.sas
**     Programmer: james r. hull
**     Start Date: 2007 09 09
**     Purpose:
**        1.) Create the same set of migration variables used in MA
**     Input Data:
**        1.) '/nangrong/data_sas/1994/current/hh94.03'
**        2.) '/nangrong/data_sas/1994/current/indiv94.03'
          3.) '/trainee/jrhull/diss/ch3/c3data/c3_94_01.xpt'
**     Output Data:
**        1.) '/trainee/jrhull/diss/ch3/c3data/c3_94_02.xpt'
**
*********************************************************************;
...
libname in94_3 xport '/trainee/jrhull/diss/ch3/c3data/c3_94_01.xpt';

libname out94_1 xport '/trainee/jrhull/diss/ch3/c3data/c3_94_02.xpt';
...
data work94_2;                                                                  *** Create a HH-level file ***;
...
data work94_3 noricefile;                               *** MERGE HHs w/ migrants to all HHs ***;
     merge work94_2 (in=a)
           in94_3.c3_94_01 (in=b);
     by HHID94;
